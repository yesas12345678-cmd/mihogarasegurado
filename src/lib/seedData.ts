...
const COBERTURAS_NEW = [
  ...
  { t: "Daños por vandalismo en el seguro de hogar: Límites y exclusiones reales", k: "daños vandalismo seguro hogar", s: "daños-vandalismo-seguro-hogar-cobertura", ex: "Analizamos qué cubre el seguro ante pintadas en fachadas, roturas de puertas por intentos de okupación u otros actos vandálicos de terceros." },
  ...
  { t: "Daños por humo en el seguro de hogar: Incendios y mala combustión de chimeneas", k: "daños por humo seguro", s: "daños-humo-chimenea-incendio-seguro", ex: "Explicamos si el seguro cubre la limpieza de hollín por mala combustión de una chimenea o si solo responde ante fuegos accidentales." },
  ...
  { t: "Daños causados por mascotas del vecino: Quién responde y cómo reclamar al seguro", k: "daños perro vecino reclamacion", s: "daños-mascotas-vecino-reclamar-seguro", ex: "Guía para saber qué seguro debe pagar los daños materiales o lesiones causadas por el perro o gato de tu vecino de forma amistosa o judicial." },
...
const GUIAS_NEW = [
  ...
  { t: "Cómo actuar si tu vivienda sufre daños estructurales por obras en la calle", k: "daños obras calle seguro hogar", s: "daños-obras-calle-reclamar-seguro-hogar", ex: "Guía para reclamar los daños y grietas causados en tu vivienda por obras municipales, de metro o construcciones en parcelas colindantes." },
  { t: "Guía para reclamar daños al seguro de hogar tras una tormenta eléctrica", k: "reclamar tometa electrica seguro", s: "reclamar-daños-tormenta-electrica-seguro", ex: "Cómo documentar los daños por caída de rayo o sobretensión eléctrica en aparatos de aire acondicionado, calderas y electrodomésticos." },
  { t: "Cómo contratar un seguro de hogar si eres ciudadano extranjero en España", k: "seguro hogar extranjeros españa", s: "seguro-hogar-extranjeros-españa-guia", ex: "Requisitos de documentación (NIE, pasaporte) y cuentas bancarias españolas necesarios para asegurar viviendas en propiedad o alquiler." },
